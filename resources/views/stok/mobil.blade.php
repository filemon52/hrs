...
<div class="uper">
      ...
      @else
        <input type="number" id="banyak" value="{{count($merk)}}" style="display: none">
        @foreach($merk as $merks)
        <p><a href="{{ url('/merkmobil',$merkmobil=$merks->nama_merk) }}" style="margin-left: 1%">{{$merks->nama_merk}} >></a></p>
