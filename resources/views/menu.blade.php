...
#event{width: 65%; height: 325px;display: inline-block;margin-right: 5%}
.side{
...
#event{width: 95%; height: 325px;display: inline-block;margin-right: 5%}
.side{
  width: 85%;
  display: block;
}
...
<div class="uper">
  ...
  <div class="down">
    <p><a href="{{ url('/item') }}" style="margin-left: 1%">NEW ITEM >></a></p>
      @if($stok == null)
      <p style="margin-left: 5%">Tidak Ada Barang Baru</p>
      @else
        <input type="number" id="total" value="{{count($stok)}}" style="display: none">
